...
>
        ...
        <div className="text-lg lg:text-base cursor-pointer">About</div>
        <div className="text-lg lg:text-base cursor-pointer">Services</div>
        <div className="text-lg lg:text-base cursor-pointer">Products</div>
